...
def get_args():
    ...
    parser.add_argument('--obs-masking-dist', type=float, default=0, help='distance to restrict comms')
    ...
    parser.add_argument('--num-frames', type=int, default=int(10e9), help='number of frames to train (default: 50e6)')
    parser.add_argument('--arena-size', type=float, default=1.0, help='size of arena')
    parser.add_argument('--cuda-num', type=int, default=0, help='num of cuda')

    # evaluation
    parser.add_argument('--num-eval-episodes', type=int, default=100, help='number of episodes to evaluate with')
    parser.add_argument('--dist-threshold', type=float, default=0.5, help='distance within landmark is considered covered (for simple_spread)')
    parser.add_argument('--render', action='store_true')
    parser.add_argument('--record-video', action='store_true', default=False, help='record evaluation video')
    parser.add_argument('--plot', action='store_true', default=False, help='record evaluation video')
    ...
    parser.add_argument('--dynamic', action='store_true', help='restrict communication to within some threshold')
    ...
    args.save_dir = os.getcwd()+'/marlsave/'+args.save_dir
    # print(args.save_dir)
